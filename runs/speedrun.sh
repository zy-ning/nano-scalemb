...
# Default intermediate artifacts directory is in ~/.cache/nano_scalemb
export OMP_NUM_THREADS=1
export NANO_SCALEMB_BASE_DIR="${NANO_SCALEMB_BASE_DIR:-${NANOCHAT_BASE_DIR:-$HOME/.cache/nano_scalemb}}"
...
python -m nano_scalemb.dataset -n 8
...
python -m nano_scalemb.dataset -n 170 &
...
# download 2.3MB of synthetic identity conversations to impart a personality to nano_scalemb
# see dev/gen_synthetic_data.py for details on how this data was prepared and to get a sense of how you can easily tune it
curl -L -o "$NANO_SCALEMB_BASE_DIR/identity_conversations.jsonl" https://karpathy-public.s3.us-west-2.amazonaws.com/identity_conversations.jsonl
