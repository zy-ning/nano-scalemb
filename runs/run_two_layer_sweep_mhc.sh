...
# Full nano-scalemb two-layer Engram+mHC sweep.
# Cases are two-layer ablations around the best three-layer sweep candidates.
...
LOG_DIR="${LOG_DIR:-$REPO_DIR/runs/logs/two_layer_sweep_mhc-$RUN_SUFFIX}"
REPORT_DIR="${REPORT_DIR:-$REPO_DIR/runs/reports/two_layer_sweep_mhc-$RUN_SUFFIX}"
...
run_case() {
    ...
    local engram_seed="$4"
    local model_tag="nano-scalemb-d24-2layer-${layer_label}-mhc-${RUN_SUFFIX}"
...
run_case "312" "3,12" "1280" "56"
run_case "317" "3,17" "1280" "56"
run_case "812" "8,12" "1280" "56"
run_case "817" "8,17" "1280" "56"
run_case "1217" "12,17" "1280" "56"

echo "Two-layer sweep complete. Reports: $REPORT_DIR"
