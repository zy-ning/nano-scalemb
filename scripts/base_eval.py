...
Examples:
    ...
    # Evaluate a nano_scalemb model (e.g. d24) using 8 GPUs
...
from nano_scalemb.common import compute_init, compute_cleanup, print0, get_base_dir, autodetect_device_type, download_file_with_lock
from nano_scalemb.tokenizer import HuggingFaceTokenizer, get_token_bytes
from nano_scalemb.checkpoint_manager import load_model
from nano_scalemb.core_eval import evaluate_task
...
class ModelWrapper:
    """Lightweight wrapper to give HuggingFace models a nano_scalemb-compatible interface."""
...
def main():
    ...
    parser.add_argument('--model-tag', type=str, default=None, help='nano_scalemb model tag to identify the checkpoint directory')
