...
from nano_scalemb.common import download_file_with_lock
...
"""
    ...
    def evaluate(self, conversation, assistant_response):
        ...
        """
        details = self.evaluate_with_details(conversation, assistant_response)
        return int(details["passed"])

    def evaluate_with_details(self, conversation, assistant_response):
        """Given (conversation, completion), return structured evaluation details."""
        ...
        return {
            ...
            "reference_answer": ref_num,
            "predicted_answer": pred_num,
            "had_answer_marker": pred_num is not None,
            "raw_reference_text": last_text_part,
        }
