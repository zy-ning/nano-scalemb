...
def get_system_info():
    ...
    info['nano_scalemb_base_dir'] = os.environ.get(
        'NANO_SCALEMB_BASE_DIR',
        os.environ.get('NANOCHAT_BASE_DIR', 'out'),
    )
...
def generate_header():
    ...
    header = f"""# nano_scalemb training report
    ...
    def generate(self):
        ...
        with open(report_file, "w", encoding="utf-8") as out_file:
            ...
            if os.path.exists(header_file):
                ...
                print(f"Warning: {header_file} does not exist. Did you forget to run `nano_scalemb reset`?")
...
# -----------------------------------------------------------------------------
# nano_scalemb-specific convenience functions
...
def get_report():
    ...
    from nano_scalemb.common import get_base_dir, get_dist_info
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Generate or reset nano_scalemb training reports.")
